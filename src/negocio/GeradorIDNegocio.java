...
public class GeradorIDNegocio {
    ...
    private String gerarNovoId(String prefixo) {
        ...
        for (int i = 0; i < 4; i++) {
            sb.append(random.nextInt(10)); // de 0 a 9
        }
        return sb.toString();
    }
    
    // metodos de constantes para expor os prefixos dos ids das clsses
    ...
    public String getPrefixoIngresso(){return GeradorID.getInstancia().getPrefixoIngressso();}
